...
// //         => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=books_exchanger;Username=postgres;Password=andrew7322");
// //
// //     protected override void OnModelCreating(ModelBuilder modelBuilder)
// //     {
// //         modelBuilder
...
// //             entity.HasKey(e => e.Id).HasName("books_pkey");
// //
// //             entity.Property(e => e.CountRating).HasDefaultValueSql("0");
// //             entity.Property(e => e.CreatedAt).HasDefaultValueSql("now()");
// //             entity.Property(e => e.SumRating).HasDefaultValueSql("0");
// //
// //             entity.HasOne(d => d.Genre).WithMany(p => p.Books).HasConstraintName("books_genre_id_fkey");
// //         });
// //
// //         modelBuilder.Entity<Feedback>(entity =>
// //         {
...
// //             entity.Property(e => e.CreatedAt).HasDefaultValueSql("now()");
// //
// //             entity.HasOne(d => d.Book).WithMany(p => p.Feedbacks).HasConstraintName("feedbacks_book_id_fkey");
// //
// //             entity.HasOne(d => d.GivenByUser).WithMany(p => p.Feedbacks).HasConstraintName("feedbacks_given_by_user_id_fkey");
// //         });
// //
// //         modelBuilder.Entity<Genre>(entity =>
// //         {
...
// //             entity.Property(e => e.CreatedAt).HasDefaultValueSql("now()");
// //
// //             entity.HasOne(d => d.Book).WithMany(p => p.Offers).OnDelete(DeleteBehavior.Cascade).HasConstraintName("offers_book_id_fkey");
// //
// //             entity.HasOne(d => d.Owner).WithMany(p => p.Offers).HasConstraintName("offers_owner_id_fkey").OnDelete(DeleteBehavior.Cascade);
// //         });
// //
// //         modelBuilder.Entity<OffersCollector>(entity =>
// //         {
...
// //             entity.Property(e => e.Id).HasDefaultValueSql("gen_random_uuid()");
// //             entity.Property(e => e.CreatedAt).HasDefaultValueSql("now()");
// //             // entity.Property(e => e.ModerationStatus).HasConversion(new EnumToStringConverter<ModerationStatus>());
// //                 // .HasConversion(c => c.ToString().ToLower(), c => Enum.Parse<ModerationStatus>(c));
// //
// //             entity.HasOne(d => d.Genre).WithMany(p => p.OffersCollectors).HasConstraintName("offers_collector_genre_id_fkey");
// //
// //             entity.HasOne(d => d.Owner).WithMany(p => p.OffersCollectors).HasConstraintName("offers_collector_owner_id_fkey");
// //         });
// //
// //         modelBuilder.Entity<User>(entity =>
// //         {
